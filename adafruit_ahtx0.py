...
try:
    from machine import I2C  # pylint: disable=unused-import
except ImportError:
    pass
...
class AHTx0:
    ...
    **Quickstart: Importing and using the AHT10/AHT20 temperature sensor**
    ...
    def __init__(
        self, i2c_bus: I2C, address: int = AHTX0_I2CADDR_DEFAULT
    ) -> None:
...
#            raise RuntimeError("Could not calibrate")
    ...
    def reset(self) -> None:
        ...
        self.i2c_device.write(self._buf, start=0, end=1)
        time.sleep(0.02)  # 20ms delay to wake up
    ...
    def calibrate(self) -> bool:
        ...
        self._buf[1] = 0x08
        self._buf[2] = 0x00
        self.i2c_device.write(self._buf, start=0, end=3)
    ...
    def status(self) -> int:
        ...
        self.i2c_device.readinto(self._buf, start=0, end=1)
    ...
    def _readdata(self) -> None:
        ...
        while self.status & AHTX0_STATUS_BUSY:
            time.sleep(0.01)
        self.i2c_device.readinto(self._buf, start=0, end=6)
